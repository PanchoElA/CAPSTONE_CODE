...
public final class ActivityScanBinding implements ViewBinding {
  ...
  private ActivityScanBinding(@NonNull FrameLayout rootView, @NonNull Button buttonBack,
      @NonNull PreviewView previewView, @NonNull TextView textViewResult) {
  ...
  public static ActivityScanBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityScanBinding((FrameLayout) rootView, buttonBack, previewView,
          textViewResult);
    }
